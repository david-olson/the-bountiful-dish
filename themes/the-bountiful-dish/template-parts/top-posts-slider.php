<div class="slide white-bg match-height">
	<article <?php post_class('medium-pad-full'); ?> id="top_post_<?php the_ID(); ?>">
		<div class="grid-x grid-padding-x align-middle">
			<div class="large-12 cell"><?php the_category( $separator = ', '); ?></div>
			<div class="large-8 cell"><h2 class="green"><?php the_title(); ?></h2></div>
